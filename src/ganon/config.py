...
class Config:
    ...
    def __init__(self, which: str=None, **kwargs):
        ...
        table_group_optional.add_argument('-r', '--rank',                     type=str,   metavar='', default=None,         help="Report only at a specific rank")
        ...
        table_group_optional.add_argument('--header',                         type=str,   metavar='', default="name_lineage",help='Header information [name, taxid, taxid_lineage, name_lineage]. Default: name_lineage')
