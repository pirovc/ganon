...
class TestUpdate(unittest.TestCase):
    ...
    def setUpClass(self):
        self.results_dir = (
            base_dir + "results/integration/update_" + self.filter_type + "/"
        )
    ...
    def test_output_db_prefix(self):
        ...
        build_params = {
            "db_prefix": self.results_dir + "test_output_db_prefix",
        ...
        os.system(
            "sed -i 's/archaea,bacteria/archaea,bacteria,viral/' "
            + build_params["db_prefix"]
            + "_files/history.tsv"
        )
    ...
    def test_db_prefix(self):
        ...
        build_params = {
            "db_prefix": self.results_dir + "test_db_prefix",
            "organism_group": ["archaea", "bacteria"],
            "source": ["genbank"],
            "taxonomy": "skip",
            "level": "assembly",
