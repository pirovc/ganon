...
class TestReport(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        # Build base database
        build_params = {
            "db_prefix": self.results_dir + "base_build",
        ...
        self.assertTrue(
            run_ganon(build_cfg, build_params["db_prefix"]),
            "ganon build-custom run failed",
        )
        self.assertIsNotNone(
            build_sanity_check_and_parse(vars(build_cfg)),
            "ganon build-custom sanity check failed",
        )

        # Build second base database
        build_params = {
            "db_prefix": self.results_dir + "base_build2",
        ...
        self.assertTrue(
            run_ganon(classify_cfg, classify_params["output_prefix"]),
            "ganon classify exited with an error",
        )
        self.assertIsNotNone(
            classify_sanity_check_and_parse(vars(classify_cfg)),
            "ganon classify sanity check failed",
        )
    ...
    def test_min_count(self):
        ...
        self.assertTrue(
            (
                res["tre_pd"][~res["idx_base"]]["cumulative"] >= params["min_count"]
            ).all(),
    ...
    def test_min_count_perc(self):
        ...
        self.assertTrue(
            (
                res["tre_pd"][~res["idx_base"]]["cumulative_perc"]
    ...
    def test_max_count(self):
        ...
        self.assertTrue(
            (
                res["tre_pd"][~res["idx_base"]]["cumulative"] <= params["max_count"]
            ).all(),
    ...
    def test_report_type_reads(self):
        ...
        self.assertEqual(
            ...
            0,
            "ganon report has wrong output for --report_type reads",
        )
    ...
    def test_report_type_matches(self):
        ...
        self.assertFalse(
            (res["tre_pd"]["rank"] == "unclassified").any(),
    ...
    def test_report_type_dist(self):
        ...
        self.assertTrue(
            res["tre_pd"][res["tre_pd"]["rank"] == "assembly"]["shared"].sum() > 0,
            "ganon report has wrong output for --report_type dist",
        )
    ...
    def test_ranks(self):
        ...
        self.assertTrue(
            (res["tre_pd"][~res["idx_base"]]["rank"].isin(params["ranks"])).all(),
    ...
    def test_ranks_all(self):
        ...
        self.assertTrue(
            (res["tre_pd"][~res["idx_base"]]["rank"] == "no rank").any(),
            "ganon report did not report the correct ranks",
        )
    ...
    def test_skip_hierachy(self):
        ...
        self.assertFalse(
            (res["tre_pd"][~res["idx_base"]]["rank"].isin(["assembly"])).any(),
    ...
    def test_split_hierachy(self):
        ...
        for file, r in res.items():
            total_root_split += r["tre_pd"][r["tre_pd"]["rank"] == "root"][
                "cumulative_perc"
            ].values[0]
        # sum one time unclassified
        total_root_split += r["tre_pd"][r["tre_pd"]["rank"] == "unclassified"][
            "cumulative_perc"
        ].values[0]
    ...
    def test_multiple_rep_files(self):
        ...
        params = self.default_params.copy()
        params["input"] = [
            self.results_dir + "base_classify.rep",
    ...
    def test_multiple_rep_files_folder(self):
        ...
        shutil.copy(
            self.results_dir + "base_classify.rep", self.results_dir + "multi_files/"
        )
        shutil.copy(
            self.results_dir + "base_classify2.rep", self.results_dir + "multi_files/"
        )
        ...
        self.assertEqual(
            len(res),
            len(list_files_folder(params["input"][0], ext=params["input_extension"])),
            "ganon report did not generate multiple report files",
        )
    ...
    def test_multiple_rep_files_split_hierachy(self):
        ...
        params["output_prefix"] = (
            self.results_dir + "test_multiple_rep_files_split_hierachy_"
        )
        params["split_hierarchy"] = True
    ...
    def test_names(self):
        ...
        self.assertEqual(
            res["tre_pd"][~res["idx_base"]]["name"].values[0],
            params["names"][0],
    ...
    def test_names_with(self):
        ...
        self.assertTrue(
            (
                res["tre_pd"][~res["idx_base"]]["name"].str.contains(
                    params["names_with"][0]
                )
            ).all(),
    ...
    def test_top_percentile(self):
        ...
        """
        params = self.default_params.copy()
        params["output_prefix"] = self.results_dir + "test_top_percentile_default"
        ...
        self.assertTrue(
            (total_by_rank / 2)
            .apply(ceil)
            .equals(res["tre_pd"][~res["idx_base"]].groupby(["rank"]).size()),
    ...
    def test_na(self):
        ...
        self.assertTrue(
            (res["tre_pd"][~res["idx_base"]]["rank"] == "na").any(),
            "ganon report did not report the correct ranks",
        )
    ...
    def test_only_orphan(self):
        ...
        # Should not report any "na"
        self.assertTrue(
            (res["tre_pd"][~res["idx_base"]]["rank"] == "na").all(),
            "ganon report did not report the correct ranks",
        )
    ...
    def test_output_format_bioboxes(self):
        ...
        params = self.default_params.copy()
        params["output_prefix"] = self.results_dir + "test_output_format_bioboxes_base"
        params["output_format"] = "tsv"
        ...
        params = self.default_params.copy()
        params["output_prefix"] = self.results_dir + "test_output_format_bioboxes"
        ...
        self.assertTrue(
            res["tre_pd"][~res["idx_base"]]["target"].isin(taxid).all(),
