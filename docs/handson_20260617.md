...
Download prepared files and unpack it in a working directory of choice:
...
The easiest way to install ganon is with [conda](https://conda-forge.org/download/) (instuctions below) but you can also install it from the [source](https://pirovc.github.io/ganon/#installation-from-source) if you prefer.
